...
const Footer = () => {
    return (
        <div>
        <footer className="footer p-10 bg-slate-800 text-base-300 mt-20 rounded-t-xl " data-aos="fade-down"
        data-aos-easing="linear"
        data-aos-duration="500">
  <aside>
   <img className='object-cover rounded-md' src={logo} alt="" />
    <p>Meta Ads Shop.<br/>Providing reliable service since 2018</p>
  </aside> 
...
<footer className="footer items-center p-4 bg-slate-800 text-base-300 rounded-b-xl">
